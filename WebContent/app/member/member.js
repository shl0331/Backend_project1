...
function checkId() {
	let idInput = document.joinform.memberid;
	...
	$.ajax({
		url:contextPath+"/app/member/CheckIdOk.mb?memberid="+memberid,
		type:'get',
		dataType:'text',
...
function sendit() {
	...
	let idTag = joinform.memberid;
	let pwTag = joinform.memberpw;
	let nameTag = joinform.membername;
	let ageTag = joinform.memberage;
