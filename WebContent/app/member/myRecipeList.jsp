					...
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								...
								<a href="${pageContext.request.contextPath}/app/recipe/recipeList.rc?memberId="${session.memberid}>내가 등록한 레시피 보러가기</a>
													...
													<c:choose>
														...
														<td>
															<div style="border: 1px solid #ddd; width: 300px; height: 300px;">
																<img alt="레시피 사진" src="${pageContext.request.contextPath}/images/pic01.jpg" class="recipeList_img" style="width: 100%; height: 70%;">
																<div>
																	레시피명:${recipe.recipeName}<br>
																	유저명:${recipe.recipeName}<br>
																	조회수:1000 
																</div>
															</div>
														</td>
								...
								<!--  </table> -->
								<a  href="${pageContext.request.contextPath}/app/recipe/recipeRegister.jsp" class="button small">등록하기</a>
